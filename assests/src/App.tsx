  ...
  showLoggedInBar = () => (
    <Fragment>
      <LinkContainer to="/past">
        <NavItem><span className="brown line-height-24">Past orders</span></NavItem>
      </LinkContainer>
      <LinkContainer to="/best">
        <NavItem><span className="brown line-height-24">Best sellers</span></NavItem>
      </LinkContainer>
      <NavItem onClick={this.handleLogout}><span className="brown line-height-24">Log out</span></NavItem>
  ...
  showLoggedOutBar = () => (
    <Fragment>
      <LinkContainer to="/signup">
        <NavItem><span className="brown">Sign up</span></NavItem>
      </LinkContainer>
      <LinkContainer to="/login">
        <NavItem><span className="brown">Log in</span></NavItem>
      </LinkContainer>
    </Fragment>
  );
      ...
      <div className="App container">
        <Navbar fluid collapseOnSelect>
          <Navbar.Header>
            <Navbar.Brand>
              <Link to="/">
                <span className="brown">E-Commerce Store</span>
              </Link>
            </Navbar.Brand>
            <Navbar.Toggle />
          </Navbar.Header>
